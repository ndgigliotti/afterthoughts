...
**Afterthoughts default:** Excludes all special tokens (`exclude_special_tokens=True`).
...
Excluding all special tokens is simpler, consistent across all chunks, and more semantically justifiable.
